...
angular.module('app', ['ngRoute','ngResource', 'xeditable', 'zingchart-angularjs', 'msieurtoph.ngCheckboxes', 'app.userAuth', 'app.dashboard','app.landingPage','app.receiptsView','app.receiptsViewWithOption','app.splitItem','app.splitTotal', 'app.addReceipts', 'app.createGroup'])
